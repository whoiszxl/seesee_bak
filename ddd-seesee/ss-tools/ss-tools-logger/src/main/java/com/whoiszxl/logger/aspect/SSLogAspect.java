package com.whoiszxl.logger.aspect;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.StrUtil;
import cn.hutool.core.util.URLUtil;
import cn.hutool.extra.servlet.ServletUtil;
import com.whoiszxl.context.BaseContextHandler;
import com.whoiszxl.logger.entity.OptLogDTO;
import com.whoiszxl.logger.event.SysLogEvent;
import com.whoiszxl.logger.utils.LogUtil;
...
public class SSLogAspect {
     ...
     */
    @Pointcut("@annotation(com.whoiszxl.logger.annotation.SSLog)")
    public void ssLogAspect() {
