...
class FollowTabHeader extends StatefulWidget {

  const FollowTabHeader({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => FollowTabHeaderState();
}

class FollowTabHeaderState extends State<FollowTabHeader> {
